...
По заданному на вход вашей программе графу требуется установить, является
ли он решёткой, а также, является ли он дистрибутивной, импликативной решёткой,
булевой алгеброй. Гарантируется, что граф задаёт частичный порядок.
...
вершины $i_k$, что $i \sqsubseteq i_k$.
