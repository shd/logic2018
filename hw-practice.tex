...
{\it Стоимость: 1 балл, решение на Ocaml или Haskell: 1 балл}\vspace{2mm}\\

На вход программе (в файле \texttt{task0.in}) подаётся выражение в следующей грамматике:
\vspace{-1mm}
...
Написать программу, разбирающую выражение и строящую дерево разбора
выводящую его в файл \texttt{task0.out} в следующей грамматике.
\vspace{-1mm}
\begin{bnf}\begin{eqnarray*}
\ntm{файл} &::=& \ntm{выражение}\\
\ntm{выражение} &::=& \lit{(}\ntm{знак}\lit{,}\ntm{выражение}\lit{,}\ntm{выражение}\lit{)}\\
...
корректность. Входной файл соответствует грамматике из задания 0.
